    ...
    return (
        <div className="min-h-screen bg-white py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h1 className="text-4xl font-bold text-slate-900 mb-6">Orthodontics Assistant Course</h1>
                ...
                <div className="prose max-w-none text-slate-700 space-y-8">
                    <section>
                        ...
                        <p>The topics listed below are covered in the Academy of Orthodontic Assisting – Level 1 program.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                            <div>
                                <h4 className="font-semibold text-slate-900">1. Oral and Dental Anatomy</h4>
                                <ul className="list-disc pl-5 text-sm">
                                    <li>Oral anatomy</li>
                                    <li>Dental anatomy</li>
                                    <li>Tooth development</li>
                                    <li>Tooth numbering</li>
                                    <li>Tooth surfaces and directions</li>
                                    <li>Malocclusions</li>
                                </ul>
                            </div>

                            <div>
                                <h4 className="font-semibold text-slate-900">2. What is Orthodontics?</h4>
                                <ul className="list-disc pl-5 text-sm">
                                    <li>Introduction</li>
                                    <li>Dentistry and dental specialties</li>
                                    <li>Types of orthodontic treatment</li>
                                    <li>Stages of treatment</li>
                                    <li>Orthodontic instruments</li>
                                    <li>How teeth move</li>
                                </ul>
                            </div>

                            <div>
                                <h4 className="font-semibold text-slate-900">3. The Orthodontic Appliance</h4>
                                <ul className="list-disc pl-5 text-sm">
