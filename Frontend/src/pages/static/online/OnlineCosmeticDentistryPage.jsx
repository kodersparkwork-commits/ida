            ...
            API.get('/api/video-folders')
                .then(res => {
                    const courseFolders = res.data.filter(folder =>
                        folder.courseId?.slug === 'online-cosmetic-dentistry'
                    );
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-slate-50 border-b border-slate-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    {!user?.enrolledCourses?.includes('online-cosmetic-dentistry') && (
            ...
            <div className="bg-slate-900 py-12 shadow-inner">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="aspect-video w-full rounded-xl overflow-hidden shadow-2xl bg-black relative group ring-1 ring-white/10">
                        {user && user.enrolledCourses && user.enrolledCourses.includes('online-cosmetic-dentistry') ? (
                            <iframe
                                width="100%"
                                height="100%"
                                src="https://www.youtube.com/embed/ZWj-WLgHQAc"
                                title="Cosmetic Dentistry Demo"
                                frameBorder="0"
                    ...
                    <p className="text-center text-slate-400 mt-4 text-sm font-medium tracking-wide uppercase">Demo Video: Cosmetic Dentistry Course</p>
                </div>
            </div>

            {/* Course Content / Playlist Section */}
            {user?.enrolledCourses?.includes('online-cosmetic-dentistry') && videoFolders.length > 0 && (
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        <section>
                            ...
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 list-disc pl-5 text-slate-700">
                                ...
                                <li>Smile evaluation, aesthetic considerations</li>
                                <li>Anterior and posterior direct composites</li>
                                <li>All-ceramic systems</li>
                                ...
                                <li>Treatment planning for aesthetic problems</li>
                            </ul>
                        </section>
