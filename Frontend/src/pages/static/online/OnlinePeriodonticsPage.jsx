            ...
            API.get('/api/video-folders')
                .then(res => {
                    const courseFolders = res.data.filter(folder =>
                        folder.courseId?.slug === 'online-periodontics'
                    );
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-slate-50 border-b border-slate-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    {!user?.enrolledCourses?.includes('online-periodontics') && (
            ...
            <div className="bg-slate-900 py-12 shadow-inner">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="aspect-video w-full rounded-xl overflow-hidden shadow-2xl bg-black relative group ring-1 ring-white/10">
                        {user && user.enrolledCourses && user.enrolledCourses.includes('online-periodontics') ? (
                            <iframe
                                width="100%"
                                height="100%"
                    ...
                    <p className="text-center text-slate-400 mt-4 text-sm font-medium tracking-wide uppercase">Demo Video: Periodontics Course</p>
                </div>
            </div>

            {/* Course Content / Playlist Section */}
            {user?.enrolledCourses?.includes('online-periodontics') && videoFolders.length > 0 && (
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        <section>
                            ...
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 list-disc pl-5 text-slate-700">
                                ...
                                <li>Gingival and periodontal diseases</li>
                                ...
                                <li>Gingivectomy & Flap surgery</li>
                                ...
                                <li>Bone graft selections and placement</li>
                            </ul>
                        </section>

                        <section className="bg-slate-50 p-8 rounded-2xl border border-slate-100">
                            <h3 className="text-xl font-bold text-slate-900 mb-4">Practical Training & Support</h3>
